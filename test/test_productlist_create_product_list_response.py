...
class TestProductlistCreateProductListResponse(unittest.TestCase):
    """ProductlistCreateProductListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductlistCreateProductListResponse:
        """Test ProductlistCreateProductListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductlistCreateProductListResponse`
        """
        model = ProductlistCreateProductListResponse()
        if include_optional:
    ...
    def testProductlistCreateProductListResponse(self):
        """Test ProductlistCreateProductListResponse"""
