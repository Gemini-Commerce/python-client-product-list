...
class ProductlistProductListAssociation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "listId", "position", "productGrn"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductlistProductListAssociation from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProductlistProductListAssociation from a dict"""
        if obj is None:
            return None
